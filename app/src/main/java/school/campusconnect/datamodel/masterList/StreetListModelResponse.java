...
public class StreetListModelResponse extends BaseResponse implements Serializable {

    @SerializedName("data")
    @Expose
    private ArrayList<StreetData> data;

    public ArrayList<StreetData> getData() {
        return data;
    }

    public void setData(ArrayList<StreetData> data) {
        this.data = data;
    }

    public static class StreetData implements Serializable
    {
