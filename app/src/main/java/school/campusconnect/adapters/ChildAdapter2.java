...
public class ChildAdapter2 extends AGVRecyclerViewAdapter<ChildAdapter2.ViewHolder> {
    ...
    public ChildAdapter2(int mDisplay, int mTotal, Context context, ArrayList<String> allImageList) {
