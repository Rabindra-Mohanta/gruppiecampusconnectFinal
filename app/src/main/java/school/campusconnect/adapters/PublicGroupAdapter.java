...
public class PublicGroupAdapter extends RecyclerView.Adapter<PublicGroupAdapter.ImageViewHolder> {
    private List<PublicGroupItem> list = Collections.emptyList();
    private OnGroupSelectListener listener;
    private Context mcontext;

    public PublicGroupAdapter(List<PublicGroupItem> list, OnGroupSelectListener listener) {
        if (list == null) return;
        this.list = list;
    ...
    public void onBindViewHolder(final ImageViewHolder holder, final int position) {
        final PublicGroupItem item = list.get(position);
...
//            notifyDataSetChanged();
    ...
    public interface OnGroupSelectListener {
        void onGroupSelect(PublicGroupItem item);
