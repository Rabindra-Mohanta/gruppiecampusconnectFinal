...
public class GalleryVideoAdapter extends AGVRecyclerViewAdapter<GalleryVideoAdapter.ViewHolder> {
    ...
    public GalleryVideoAdapter(int mDisplay, int mTotal, Context context, GalleryPostRes.GalleryData item) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final List<ItemImage> item, final int position, int mDisplay, int mTotal, final Context mContext) {
            ...
            if(new AmazoneVideoDownload(context).isVideoDownloaded(mContext,item.get(position).getImagePath())){
            ...
            mImageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("data",new Gson().toJson(GalleryVideoAdapter.this.item));
