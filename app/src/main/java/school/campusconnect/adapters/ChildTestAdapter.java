...
public class ChildTestAdapter extends AGVRecyclerViewAdapter<ChildTestAdapter.ViewHolder> {
    private final TestParentActivity acContext;
    private final TestPaperRes.TestPaperData assignmentData;
    ...
    public ChildTestAdapter(int mDisplay, int mTotal, Context context, ArrayList<String> allImageList, TestParentActivity acContext, TestPaperRes.TestPaperData item) {
