...
public class AllStaffListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.activity_all_staff_list);
    ...
    public void onSuccess(int apiId, BaseResponse response) {
        ...
        binding.rvStaff.setAdapter(new StaffAdapter(res.getData()));
    }
    ...
    public class StaffAdapter extends RecyclerView.Adapter<StaffAdapter.ViewHolder>
    {
        ...
        public StaffAdapter(ArrayList<StaffResponse.StaffData> list) {
            this.list = list;
        }
