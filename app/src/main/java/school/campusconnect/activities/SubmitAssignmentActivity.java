...
public class SubmitAssignmentActivity extends BaseActivity implements LeafManager.OnAddUpdateListener<AddPostValidationError>, View.OnClickListener, UploadImageAdapter.UploadImageListener {
    ...
    private void init() {
        ...
        if (getIntent() != null) {
            ...
            AppLog.e(TAG,"assignmentId : "+assignmentId);
        }
            ...
            if (isValid(true)) {
                ...
                if (!TextUtils.isEmpty(videoUrl)) {
                  ...
                  /*  if (isEdit) {
                        ...
                        manager.submitAssignmentPost(this, group_id, team_id, subject_id,assignmentId, mainRequest);
//                    }
        ...
        protected Boolean doInBackground(Void... voids) {
            try {
                for (int i = 0; i < listImages.size(); i++) {
                    ...
                    if (fileSizeInMB > 10) {
                        listImages.set(i, SiliCompressor.with(SubmitAssignmentActivity.this).compressVideo(listImages.get(i), getExternalCacheDir().getAbsolutePath() , w ,h , 950000));
            ...
            try {
                ...
                observer.setTransferListener(new TransferListener() {
                    ...
                    public void onError(int id, Exception ex) {
                        ...
                        Toast.makeText(SubmitAssignmentActivity.this, getResources().getString(R.string.image_upload_error), Toast.LENGTH_SHORT).show();
                    }
                });
            } catch (IOException e) {
                e.printStackTrace();
        ...
        switch (apiId) {
            ...
            case LeafManager.API_SUBMIT_ASSIGNMENT:
               ...
               /* if (isEdit) {
                    ...
                    LeafPreference.getInstance(SubmitAssignmentActivity.this).setBoolean("is_assignment_added", true);
...
//                }
    ...
    public void showPhotoDialog(int resId) {
        SMBDialogUtils.showSMBSingleChoiceDialog(SubmitAssignmentActivity.this,
...
//                String path = ImageUtil.getPath(this, selectedImage);
                ...
                SubmitAssignmentActivity.this.getContentResolver().takePersistableUriPermission(
    ...
    public void showYoutubeDialog() {
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (videoUrl.equals(""))
                    ...
                    Picasso.with(SubmitAssignmentActivity.this)
                            .load(img_url)
        ...
        btn_upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(SubmitAssignmentActivity.this, MainActivity.class));
            }
        });
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                try {
                    ...
                    dataObj.put("createdById", LeafPreference.getInstance(SubmitAssignmentActivity.this).getString(LeafPreference.LOGIN_ID));
                    dataObj.put("postId", "");
