...
public class MainActivity extends BaseActivity implements
        UploadsListFragment.Callbacks, LeafManager.OnCommunicationListener {
...
//                mUploadsListFragment.setVideos(videos);
    ...
    public void onVideoSelected(VideoData video) {
        mVideoData = video;
       AppLog.e("YouTubee", "getWatchUri " + video.getWatchUri());
       AppLog.e("YouTubee", "getTitle " + video.getTitle());
       AppLog.e("YouTubee", "getThumbUri " + video.getThumbUri());
       AppLog.e("YouTubee", "getYouTubeId " + video.getYouTubeId());
        GroupDashboardActivityNew.ifVideoSelected = true;
        GroupDashboardActivityNew.selectedUrl = video.getWatchUri();
        GroupDashboardActivityNew.selectedYoutubeId = video.getYouTubeId();
        this.finish();
...
//        credential = new GoogleCredential().setAccessToken("ya29.GltGBAA3cC-UpU8EjEYiOvR2vwMtxll2UKepahcg9q3vroGyHvh2XMDPGJk4CK2WmQrSyKUW1wAXz0wCUOKSHOSrjQ1_AOpdVO2Ixo8OROgkinIA5sH409bTknyM");
    ...
    //AppLog.d(TAG, "failed to create directory");
    // return null;
    // }
    // }
    //
    ...
    private class UploadBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(REQUEST_AUTHORIZATION_INTENT)) {
               AppLog.d(TAG, "Request auth received - executing the intent");
                Intent toRun = intent
