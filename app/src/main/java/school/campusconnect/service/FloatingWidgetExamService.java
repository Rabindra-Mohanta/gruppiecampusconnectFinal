...
public class FloatingWidgetExamService extends Service {
    ...
    public void onCreate() {
        ...
        floatingFaceBubble.setImageResource(R.drawable.showpaper);
...
//                                windowManager.removeView(floatingFaceBubble);
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        AppLog.e("BubbleService", "onStartCommand called :data "+data );
    ...
    public IBinder onBind(Intent intent) {
        ...
        AppLog.e("BubbleService", "onBind :data "+data);
        return mBinder;
    }
    ...
    public class LocalBinder extends Binder {
        public FloatingWidgetExamService getService() {
            // Return this instance of LocalService so clients can call public methods
            return FloatingWidgetExamService.this;
        }
    }
