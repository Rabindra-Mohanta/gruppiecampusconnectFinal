...
public class ShareGroupTeamListFragment extends BaseFragment implements LeafManager.OnCommunicationListener,
    ...
    public ShareGroupTeamListFragment() {

    }

    public static ShareGroupTeamListFragment newInstance(String groupId, String post_id) {
        ShareGroupTeamListFragment fragment = new ShareGroupTeamListFragment();
        Bundle b = new Bundle();
    ...
    public void onClickListener(String id) {
        Intent intent = new Intent(getActivity(), ShareGroupListActivity.class);
