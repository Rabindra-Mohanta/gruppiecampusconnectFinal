...
public class TestSubjectListFragment extends BaseFragment implements LeafManager.OnCommunicationListener {
...
/*
    ...
    private void onTreeClick(SubjectStaffResponse.SubjectData classData) {
        Intent intent = new Intent(getActivity(), TestExamActivity.class);
