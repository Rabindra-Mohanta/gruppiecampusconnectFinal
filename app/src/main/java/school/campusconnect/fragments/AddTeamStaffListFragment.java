...
public class AddTeamStaffListFragment extends BaseFragment implements LeafManager.OnCommunicationListener {
    ...
    public void onSuccess(int apiId, BaseResponse response) {
        ...
        if(apiId==LeafManager.API_ID_LEAD_LIST){
            ...
            Iterator<StaffResponse.StaffData> it = result.iterator();
            while (it.hasNext()){
                StaffResponse.StaffData dt = it.next();
    ...
    public class AddTeamStaffAdapter extends RecyclerView.Adapter<AddTeamStaffAdapter.ViewHolder> {
        ...
        @Override
        public AddTeamStaffAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        @Override
        public void onBindViewHolder(final AddTeamStaffAdapter.ViewHolder holder, final int position) {
